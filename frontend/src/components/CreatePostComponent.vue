						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<ul class="list-unstyled">
									<li v-for="i in userBadges" class="row">
										<div class="card col-10 mb-2 ms-4" :style="[badge == i.id ? 'background-color:rgb(175, 209, 191)' : '']"><img class="card-img-top w-50 mt-3 mx-auto rounded-circle" :src="i.image">
											<div class="card-body">
												<div class="card-title fw-bold text-center">{{ i.name }}</div>
											</div>
										</div>
										<div class="col align-items-center d-flex"> <input type="radio" name="badges" :value="i.id" v-model="badge"> </div>
									</li>
