...
class FlaskAppTestCase(unittest.TestCase):
    ...
    def test_read_one_route(self, MockCollection):
        MockCollection.find_one.return_value = {
            "_id": "some_fake_id", "route_id": "some_id"}
    ...
    def test_update_route(self, MockCollection):
        ...
        MockCollection.find_one_and_update.return_value = {
            "route_id": "some_id"}
    ...
    def test_delete_route(self, MockCollection):
        MockCollection.find_one_and_delete.return_value = {
            "route_id": "some_id"}
